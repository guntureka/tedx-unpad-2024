                ...
                <Card className="border-gray-600 lg:mb-64 sm:mt-30 sm:mb-24 bg-white sm:mx-5 lg:mx-60">
                    <CardContent>
                        <CardDescription className="text-lg text-center py-5 text-black font-inter">
                            Thank you for participating! Your enthusiasm and
                            effort are greatly appreciated. We hope you enjoy
                            the challenges and continue to have fun while
                            solving them.
                        </CardDescription>
                    </CardContent>
                </Card>
    ...
    return (
        <div className="container mt-11">
            <Card className="border-gray-600 mt-4 bg-white sm:mx-5 lg:mx-60">
                <CardContent>
                    <CardDescription className="text-lg text-center py-5 text-black font-inter">
                        Congratulations on solving the first riddle! Your keen
                        mind and sharp instincts have led you to your first
                        victory. Keep up the great work and continue your
                        journey through the challenges ahead. Happy
                        riddle-solving!
                    </CardDescription>
                </CardContent>
            </Card>
            <Card className="border-gray-600 mt-4 mb-4 bg-white sm:mx-5 lg:mx-60">
                <CardContent>
                    <CardHeader className="text-4xl font-bold text-left font-ebgaramond">
                        Terms and Conditions Second Mission: Speech Discussion
                        Video
                    </CardHeader>
                    <div className="text-lg text-justify font-inter">
                        <ol className="list-decimal list-inside">
                            <li className="mb-3">
                                Durasi <span className="italic">speech</span>{" "}
                                berkisar antara{" "}
                                <span className="font-bold">2-5 menit.</span>
                            </li>
                            <li className="mb-3">
                                <span className="italic">Speech</span> yang
                                dibawakan boleh menggunakan{" "}
                                <span className="font-bold">
                                    {" "}
                                    bahasa apa saja
                                </span>
                                , asalkan formal dan tidak mengandung unsur
                                SARA.
                            </li>
                            <li className="mb-3">
                                Isi <span className="italic">speech</span>{" "}
                                mencakup{" "}
                                <span className="font-bold">
                                    perkenalan diri{" "}
                                </span>
                                dan <span className="font-bold">advokasi</span>{" "}
                                yang membahas permasalahan di bidang jawaban{" "}
                                <span className="italic">riddle</span>{" "}
                                sebelumnya.
                            </li>
                            <li className="mb-3">
                                Video diwajibkan{" "}
                                ...
                                , diperbolehkan membuat dengan kreativitas
                                masing-masing
                            </li>
                            <li className="mb-3">
                                ...
                                seseorang dari suatu isu sehingga berbentuk
                                tanggapan argumen atau studi kasus
                            </li>
                            <li className="mb-3">
                                Kumpulkan tautan video youtube bertipe publik
                                pada website kami.
                            </li>
                        </ol>
                    </div>
