...
const Register: React.FC = (): React.ReactNode => {
    ...
    return (
        <div className="w-screen grid md:grid-cols-2 px-4 md:px-20 items-center">
            ...
            <div className="flex flex-col justify-center p-4 md:p-10 space-y-1">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                <div className="flex items-center">
                                    ...
                                    />
                                    <label htmlFor="interestIC" className="ml-2 text-white">Inferiority Complex</label>
                                </div>
                                <div className="flex items-center">
                                    <input
                                        type="radio"
                                        ...
                                        {...register("interest", { required: "Interest is required" })}
                                    />
                                    <label htmlFor="interestPA" className="ml-2 text-white">Personalized Algorithm</label>
                                </div>
                                <div className="flex items-center">
                                    <input
                                        type="radio"
                                        ...
                                        {...register("interest", { required: "Interest is required" })}
                                    />
                                    <label htmlFor="interestQLC" className="ml-2 text-white">Quarter Life Crisis</label>
                                </div>
                                <div className="flex items-center">
                                    <input
                                        type="radio"
                                        ...
                                        {...register("interest", { required: "Interest is required" })}
                                    />
                                    <label htmlFor="interestFF" className="ml-2 text-white">Financial Freedom</label>
                                </div>
                            </div>
