...
const DashboardTest: React.FC = () => {
    ...
    return (
        <div className="w-screen px-12 sm:px-20 md:px-28 lg:px-36 xl:px-[170px]">
            <div
                className="flex flex-col md:flex-row rounded-[10px] justify-between bg-red-normal mt-[55px]
                        px-8 md:px-10 xl:px-[50px]
                        py-8 md:py-10 xl:py-[40px]"
            >
                <div className="flex flex-col gap-[8px]">
                    <h1 className="font-inter-900 text-center md:text-left text-[33px] md:text-[37px] text-white">
                        The Flavors of Wisdom
                    </h1>
                    <h2 className="font-inter-700 text-center md:text-left text-[16px] md:text-[20px] text-white/[.8]">
                        A place where wisdom can be seen and discovered
                    </h2>
                    <p className="font-inter-600 text-center md:text-left text-[12px] md:-[14px] text-white/[.8]">
                ...
                <div className="flex flex-col gap-[5px] mt-[30px] place-content-end items-center">
                    <h3 className="font-inter-600 text-[14px] text-white text-center">
                        Follow Us On:
                    </h3>
            ...
            <div className="flex flex-col bg-grey-dark rounded-[10px] border-[2px] border-grey-light px-[40px] lg:px-[160px] py-[40px] lg:py-[60px] my-[40px] justify-center">
                ...
                <div className="flex justify-center">
                    <a
                        className="flex flex-col gap-[16px] items-center max-w-fit mt-[25px]"
                        href="#"
                    >
                        ...
                        <LabeledInput2
                            ...
                            register={registerProfile("address", {
                                ...
                                pattern: {
                                    ...
                                    message:
                                        "Address must be 1-100 characters long",
                                },
                            })}
                        ...
                        <LabeledInput2
                            ...
                            register={registerProfile("hdyhau", {
                                ...
                                pattern: {
                                    value: /^.{1,100}$/,
                                    message:
                                        "Source must be 1-100 characters long",
                                },
                            })}
            ...
            <div className="flex justify-end">
                <a href="#">
                    <button className="py-[15px] px-[30px] rounded-[5px] border-[1px] border-white bg-red-dark font-inter-700 text-[16px] text-white hover:bg-red-normal duration-150">
                        Logout
                    </button>
                </a>
            </div>
