...
const Login: React.FC = () => {
  ...
  return (
    <div className="w-screen grid grid-cols-2 px-[70px] items-center">
      ...
      <div className="flex flex-col justify-center px-[90px]">
        <h1 className="text-white text-[30px] font-inter-600">Login</h1>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-between items-center mt-[22px]">
            <div className="flex items-center">
              <input className="w-[15px] h-[15px]" type="checkbox" id="remember-me" />
              <label
            ...
            <Link href="#" className="text-white text-[14px] font-inter-400 ml-[10px] hover:underline">
              Forget Password?
            </Link>
          </div>
          <button
        ...
        <p className="font-inter-500 py-[10px] text-[16px] text-grey-light text-center">or</p>
        ...
        <p className="mt-[26px] font-inter-400 py-[10px] text-[16px] text-white text-center">
          ...
          <span>
            <Link href="#" className="font-inter-600 hover:underline">Register</Link>
          </span>
        </p>
      </div>
    </div>
