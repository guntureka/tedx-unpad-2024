        ...
        <div className="w-screen grid sm:grid-cols-1 md:grid-cols-2 px-4 md:px-20 items-center">
            ...
            <div className="flex flex-col font-inter justify-center p-4 md:p-10 space-y-1 ">
                ...
                <button
                    ...
                    className="w-full h-[55px] flex gap-x-[17px] justify-center items-center rounded-[10px] bg-white font-inter-400 text-[18px] text-black-abs hover:bg-grey-light duration-150"
                >
                    <svg
